...
## Module score for viral + bacterial responses across PBMCs and myeloid cells (Tirosh et al. Science 2016)
...
# Viral score from Hadjadj et al.
...
cyto <- read.csv("Sheets/viral1_mono_module_score.csv")
...
# Example to test p vals if applicable
...
ggsave(plot1, file = "Fig2_viral_bac_fig/viral1_module_score_myeloid_specific.pdf", height = 2, width =3)
